...
**Highlights**: new parameters (`negativePrompt`, `seed`, `sampleCount`, `personGeneration`, `storageUri`, watermark, RAI reason, 4K) · 13-rule `validateConfig` with auto-fixes · cost estimation + `--dry-run` preview · hardened downloads · CI with 191 tests.
